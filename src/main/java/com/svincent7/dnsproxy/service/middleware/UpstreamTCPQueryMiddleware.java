...
@Slf4j
public class UpstreamTCPQueryMiddleware extends AbstractUpstreamQueryMiddleware {

    public UpstreamTCPQueryMiddleware(final DNSResolverFactory dnsResolverFactory) {
        super(dnsResolverFactory);
    }

    @Override
    protected Resolver getResolver(final DNSResolverFactory dnsResolverFactory) {
        return dnsResolverFactory.createTCPResolver();
    }
